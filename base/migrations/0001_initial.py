    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age', models.PositiveIntegerField(blank=True, null=True, validators=[django.core.validators.RegexValidator(message='Pincode should only contain digits', regex='^\\d+$')])),
